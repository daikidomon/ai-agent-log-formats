...
|---------|--------|---------|:----------:|------|
| **CLI** | [Claude Code](tools/claude-code/README.ja.md) | JSONL | Yes | history.jsonl + プロジェクト別セッション |
| **CLI** | [OpenAI Codex CLI](tools/openai-codex/README.ja.md) | JSONL | Yes | rollout セッションファイル |
| **CLI** | [Aider](tools/aider/README.ja.md) | Markdown / SQLite | Yes | チャット履歴 + DB |
| **CLI** | [amp](tools/amp/README.ja.md) | JSONL | Yes | セッションファイル |
| **エディタ** | [Cursor](tools/cursor/README.ja.md) | SQLite | Yes | state.vscdb + 独自ストレージ |
...
| **IDE/エディタ** | [OpenCode](tools/opencode/README.ja.md) | SQLite | Yes | opencode.db |
