...
|----------|------|-----------|:---------:|---------|
| **CLI** | [Claude Code](tools/claude-code/) | JSONL | Yes | history.jsonl + per-project sessions |
| **CLI** | [OpenAI Codex CLI](tools/openai-codex/) | JSONL | Yes | Rollout session files |
| **CLI** | [Aider](tools/aider/) | Markdown / SQLite | Yes | Chat history + DB |
| **CLI** | [amp](tools/amp/) | JSONL | Yes | Session files |
| **Editor** | [Cursor](tools/cursor/) | SQLite | Yes | state.vscdb + custom storage |
...
| **IDE/Editor** | [OpenCode](tools/opencode/) | SQLite | Yes | opencode.db |
